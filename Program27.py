import cv2
import numpy as np
image = cv2.imread(r'C:\Users\welcome\Downloads\wallpaperflare.com_wallpaper1.jpg')
img2 = cv2.imread(r'C:\Users\welcome\Downloads\Cars and Bikes Wallpaper.jpg')
